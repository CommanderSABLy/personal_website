        ...
        <div className="contact-container">
            <div className="container mt-5">
                ...
                <form className="row g-3" action="https://formsubmit.co/5ef92ad9a679167158bc88f4e7261b6f" method="POST">
                    ...
                    <input type="hidden" name="_next" value="https://www.saullynn.com/contact-email-sent" />
                    <div className="col-md-6">
                        <label htmlFor="firstName" className="form-label">First Name<span className="asterisk">*</span></label>
                        <input type="text" className="form-control" name="Name" id="firstName" placeholder="John" required />
                    </div>
                    <div className="col-md-6">
                        <label htmlFor="lastName" className="form-label">Last Name<span className="asterisk">*</span></label>
                        <input type="text" className="form-control" name="Surname" id="lastName" placeholder="Doe" required />
                    </div>
                    <div className="col-md-8">
                        <label htmlFor="emailInfo" className="form-label">Email<span className="asterisk">*</span></label>
                    ...
                    <div className="col-md-12">
                        <label htmlFor="message" className="form-label">Message<span className="asterisk">*</span></label>
